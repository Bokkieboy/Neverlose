...
local WatermarkX = menu.Slider("Misc", "X Watermark", 0, 25, 50)
local WatermarkY = menu.Slider("Misc", "Y Watermark", 0, 20, 40)
...
local watermark=function()
    ...
    local position = Vector2.new(WatermarkX(), WatermarkY())
    local indent = Vector2.new(WatermarkX(-5), WatermarkY(-5))
